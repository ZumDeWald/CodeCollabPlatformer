...
class MyGame extends Phaser.Scene
{
    ...
    create ()
    {
        ...
        // Collisions
        this.physics.add.collider(this.player, this.nav, () => {splatEnemyTop(this.player, this.nav, "navHit")}, null, this);
        this.physics.add.collider(this.player, this.nre, () => {splatEnemyTop(this.player, this.nre, 'nreHit')}, null, this);
        this.physics.add.collider(this.player, this.nre2, () => {splatEnemyRight(this.player, this.nre2, 'nreHit')}, null, this);
    }
